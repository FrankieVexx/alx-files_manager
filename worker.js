...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to ALX-Files_Manager by Myra and Francis';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/FrankieVexx/alx-files_manager">',
      'ALX-Files_Manager_Task</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/FrankieVexx/">Francis Onyach</a>. ',
      'and <a href="https://github.com/myrajarenga">Myra Jarenga</>.',
